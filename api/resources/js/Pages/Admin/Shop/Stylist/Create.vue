...
const submit = () => {
    form.post(route('admin.stylists.store', {'shop': shopId}), {
        onSuccess: () => {
            flashMessage('スタイリストを作成しました。', 'success')
        },
        onError: (e) => {
...
<template>
    ...
    <AuthenticatedShopDetailLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">スタイリスト作成</h2>
        </template>
